...
def start_server(host="0.0.0.0", port=12345):
    ...
    def handle_client(client_socket, addr):
        try:
            ...
            print(f"{clients.get(client_socket, 'Unknown')} has disconnected. Error: {e}")
            broadcast(f"Server: {clients.get(client_socket, 'Unknown')} has left the chat.")
...
if __name__ == "__main__":
    ...
    print("Welcome to the Cross-Platform Hacker Terminal!")
